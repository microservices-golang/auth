...
var file_api_user_user_proto_rawDesc = string([]byte{
	...
	0x09, 0x0a, 0x05, 0x41, 0x44, 0x4d, 0x49, 0x4e, 0x10, 0x02, 0x32, 0x84, 0x02, 0x0a, 0x0b, 0x55,
	...
	0x74, 0x79, 0x12, 0x3d, 0x0a, 0x0a, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
...
var file_api_user_user_proto_depIdxs = []int32{
	...
	0, // 4: auth.UpdateUserRequest.role:type_name -> auth.Role
	1, // 5: auth.UserService.CreateUser:input_type -> auth.CreateUserRequest
	3, // 6: auth.UserService.GetUser:input_type -> auth.GetUserRequest
	5, // 7: auth.UserService.UpdateUser:input_type -> auth.UpdateUserRequest
	6, // 8: auth.UserService.DeleteUser:input_type -> auth.DeleteUserRequest
	2, // 9: auth.UserService.CreateUser:output_type -> auth.CreateUserResponse
	4, // 10: auth.UserService.GetUser:output_type -> auth.GetUserResponse
	8, // 11: auth.UserService.UpdateUser:output_type -> google.protobuf.Empty
	8, // 12: auth.UserService.DeleteUser:output_type -> google.protobuf.Empty
